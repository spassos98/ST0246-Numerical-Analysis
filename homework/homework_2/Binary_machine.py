...
class Binary_machine:
    ...
    def dec_to_machine(self, num):
        ...
        # Exponent is positive when the integer part is greater than zero
        if int(int_part) != 0:
    ...
    def greatest_number(self):
        """
        Returns the greatest number that the machine can store.
        ...
        -------
        int
            The greatest number that the machine can store.
        """
        return (self.machine_to_dec('11' + '1'*(self.exponent_bits 
                                                + self.mantissa_len)))
                

    def smallest_number(self):
        """
        Returns the smallest positive number that the machine can store.
        ...
        int
            The greatest number that the machine can store.
        """
        return (self.machine_to_dec('10' + ('1'*self.exponent_bits) + 
                                    ('0'*(self.mantissa_len-1))+'1'))
     
                
    def operate_two_decimals(self, num1, num2, fun):
        """
        Given 2 decimal numbers and a binary arithmetic function returns 
        the result of the function.
         
        Parameters
        ----------
        num1 : numeric
            The first parameter for the binary function.   
        num2 : numeric
            The second parameter for the binary function.    
        fun : binary function
            Binary function to be applied (sum, substract, times).
             
        Returns
        -------
        str
            The result of the function in machine number.
        """
        return(self.dec_to_machine(fun(num1,num2)))
                
         
    def operate_two_machine_numbers(self, num1, num2, fun):
        """
        Given 2 decimal numbers in machine representation and a binary 
        arithmetic function returns the result of the function.
         
        Parameters
        ----------
        num1 : str
            The first parameter for the binary function as machine number.
        num2 : str
            The second parameter for the binary function as machine number.    
        fun : binary function
            Binary function to be applied (sum, substract, times).
        ...
        str
            The result of the function in machine number.
        """
        return (self.dec_to_machine(fun(self.machine_to_dec(num1),
                                        self.machine_to_dec(num2))))
        
        
    def machine_epsilon(self):
        """
        Returns the machine epsilon. Smallest number that can sum to 1.
...
def aux_subs(num1, num2):
    ...
    -------
    numeric
        The first number minus the second one 
    """
    return num1 - num2
 
                
def aux_times(num1, num2):
    """
    Times 2 numbers
    ...
    -------
    numeric
        The first number times the second one
    """
    return num1 * num2
